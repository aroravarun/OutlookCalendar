package com.outlook.calendar.view;
...
public class PinnedSectionListView extends ListView {
    public PinChangeCallback getPinChangeCallback() {
        return pinChangeCallback;
    }

    public void setPinChangeCallback(PinChangeCallback pinChangeCallback) {
        this.pinChangeCallback = pinChangeCallback;
    }
     ...
     */
    public static abstract class PinnedSectionListAdapter  extends BaseAdapter {
        /**
    ...
    private PinChangeCallback pinChangeCallback;
    ...
    void createPinnedShadow(int position) {
        ...
        if(pinChangeCallback != null){
            pinChangeCallback.pinChanged(pinnedView.getTag());
        }
    }
